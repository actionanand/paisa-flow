...
```bash
git clone https://github.com/actionanand/paisa-flow.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/paisa-flow#1-skeleton angular-proj-name
```
